 ...
 */
public class EmpMonPaySlipCalculator {
	...
	public static void main(String[] args){
		...
		EmpMonPaySlipCalculator empMonPaySlipCalculator = new EmpMonPaySlipCalculator();
		if(empMonPaySlipCalculator.execute(args[0],args[1]))
